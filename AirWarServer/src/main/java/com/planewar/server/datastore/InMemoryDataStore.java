...
public class InMemoryDataStore {
    ...
    public InMemoryDataStore(ObjectMapper objectMapper) {
        ...
        skinCatalog.add(new SkinConfig(1, "苍穹游隼", "轻型高速蓝银机体，适合作为基础换装。", 0, "plane_skin", true, "item_01"));
        skinCatalog.add(new SkinConfig(2, "沙暴掠影", "沙黄色机身与深色座舱，偏侦察风格。", 0, "plane_skin", true, "item_02"));
        skinCatalog.add(new SkinConfig(3, "猩红矛隼", "机鼻修长，红白对比明显，攻击感更强。", 0, "plane_skin", true, "item_03"));
        skinCatalog.add(new SkinConfig(4, "夜幕渡鸦", "暗色系舰载外观，强调压迫感和隐蔽感。", 0, "plane_skin", true, "item_04"));
        skinCatalog.add(new SkinConfig(5, "雷霆裁决", "厚重机翼与黄黑警戒涂装，更偏重装风格。", 0, "plane_skin", true, "item_05"));
        skinCatalog.add(new SkinConfig(6, "极昼枪骑", "亮色机身与尖锐前翼，视觉最醒目。", 0, "plane_skin", true, "item_06"));
        skinCatalog.add(new SkinConfig(7, "霜原巡航者", "冷白与深蓝拼接，强调寒区作战感。", 0, "plane_skin", true, "item_07"));
        skinCatalog.add(new SkinConfig(8, "王冠试作型", "收藏级主力机体，作为高阶终端皮肤。", 0, "plane_skin", true, "item_08"));
        skinCatalog.add(new SkinConfig(9, "纪念徽章一号", "仅可在仓库中陈列的纪念藏品。", 0, "memorabilia", false, "item_09"));
        skinCatalog.add(new SkinConfig(10, "纪念徽章二号", "舰队列装纪念款展示图。", 0, "memorabilia", false, "item_10"));
        skinCatalog.add(new SkinConfig(11, "战役纪念章", "大型战役主题纪念藏品。", 0, "memorabilia", false, "item_11"));
        skinCatalog.add(new SkinConfig(12, "巡航纪念章", "巡航编队留存纪念图。", 0, "memorabilia", false, "item_12"));
        skinCatalog.add(new SkinConfig(13, "工业纪念章", "后勤生产线主题纪念图。", 0, "memorabilia", false, "item_13"));
        skinCatalog.add(new SkinConfig(14, "战区纪念章", "特殊战区识别系列纪念图。", 2, "memorabilia", false, "item_14"));
        skinCatalog.add(new SkinConfig(15, "军械纪念章", "重工军械主题藏品。", 2, "memorabilia", false, "item_15"));
        skinCatalog.add(new SkinConfig(16, "终章纪念章", "终局演习留档的收藏品。", 2, "memorabilia", false, "item_16"));
    }
